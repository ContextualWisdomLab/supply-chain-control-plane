...
This repository is pre-release. There is no production persistence, authenticated API, deployment image, customer-facing web workflow, or released artifact yet. See `docs/product-technical-gap-baseline.md` for the commercialization sequence.
