...
| Path-level explanation | this repo | `ImpactRecord.dependency_path`, `dependency_evidence`, regression tests | preserve deterministic shortest path and immutable evidence alignment | implemented on writer branch | exact-head CI/review; multi-path property tests |
